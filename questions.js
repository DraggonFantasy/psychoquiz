...
function createArangeOptions(index) {
    ...
    console.log(option)
    for(const o of arangeOptions[index]) {
...
const questions = [
    ...
    q("methodic", "МЕТОДИКА «ЦІННІСНІ ОРІЄНТАЦІЇ» РОКИЧА",
        "Зараз Вам буде пред'явлений набір з 18 карток з позначенням цінностей. Ваше завдання - розкласти їх по порядку значимості для Вас як принципів, якими Ви керуєтеся у Вашому житті. Уважно вивчіть таблицю і, вибравши ту цінність, яка для Вас найбільш значима, помістіть її на перше місце. Потім виберіть другу за значимістю цінність і помістіть її слідом за першою. Потім виконайте те ж з усіма рештою цінностями. Найменш важлива залишиться останньою і займе 18 місце. Розробіть не поспішаючи, вдумливо. Кінцевий результат повинен відбивати Вашу справжню позицію"),
    q("arange", 1),
    q("arange", 2),
    ...
    q("methodic", "ОПИТУВАЛЬНИК “ЖИТТЄВІ ЗАВДАННЯ ОСОБИСТОСТІ” (РОЗРОБКА КОЛЕКТИВУ ЛАБОРАТОРІЇ СОЦІАЛЬНОЇ ПСИХОЛОГІЇ ОСОБИСТОСТІ ІСПП НАПН УКРАЇНИ ПІД КЕРІВНИЦТВОМ Т. М. ТИТАРЕНКО)",
        "Зазначте, будь ласка, навпроти кожного із запропонованих висловлювань свою згоду чи незгоду з ним, відмітивши один з варіантів: “згоден/згодна” або “не згоден/не згодна”. Навіть якщо Ви не можете погодитися із жодною відповіддю, все ж оберіть варіант, який більше для Вас прийнятний. \n" +
        "Тут немає “правильних” і “неправильних” відповідей. Ваша думка цінна для нас саме такою, якою вона є. Ваші відповіді конфіденційні і будуть використані тільки у вигляді статистичних даних."),
    ...
    q("agree", "Я б хотів(-ла) у майбутньому займатися улюбленою справою, але важливіше заробляти гроші"),
    ...
    q("agree", "Коли виникають перешкоди, я впевнений(-а), що впораюся з проблемою"),
    q("agree", "Завдання, які я ставлю, зазвичай виключають одне, я змушений(-а) вибирати"),
    ...
    q("agree", "Оскільки я не можу всіх зробити щасливими, я повинен(-на) подбати про себе"),
    ...
    q("agree", "Я намагаюся досягти того, що запланував(-ла), навіть усупереч обставинам"),
    q("agree", "Мені неважко тривалий час бути включеним(-ою) в активну діяльність"),
    ...
    q("agree", "Я нерідко сам(-а) не знаю, чого хочу і яким чином слід діяти в різних життєвих обставинах"),
    ...
    q("methodic", "АНКЕТА «МОТИВИ ВОЛОНТЕРСЬКОЇ ДІЯЛЬНОСТІ»", "Вам потрібно обрати варіанти або написати відповідь, яка найточніше описує Вашу думку"),
    ...
    q("choice", "Оцініть за шкалою від 0 до 5, наскільки сильно ви відчуваєте підтримку вашої діяльності оточуючими сьогодні?",
        ["0. перешкоджають мені у реалізації цього прагнення",
              "1. трохи перешкоджають мені у реалізації цього прагнення",
              "2. не підтримують мене і не перешкоджають мені у реалізації цього прагнення",
              "3. трохи підтримують мене у реалізації цього прагнення",
              "4. підтримують мене у реалізації цього прагнення",
